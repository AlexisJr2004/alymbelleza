...
async function loadProducts() {
    try {
        ...
        const productsContainer = document.querySelector('.flex-wrap');
                ...
                <div class="xl:w-1/4 md:w-1/2 p-4">
                    <div class="bg-gray-100 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                        <div class="relative">
                            ...
                            ${product.featured ? `<div class="absolute top-4 left-4">
                                <span class="bg-blue-500 text-white px-3 py-1 rounded-full text-xs font-semibold tracking-wide">DESTACADO</span>
                            </div>` : ''}
                        </div>
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-3">
                                <h3 class="text-blue-600 text-sm font-medium tracking-wider">${product.category}</h3>
                                <svg class="w-6 h-6 text-gray-400 hover:text-blue-500 cursor-pointer transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                ...
                                <a href="${product.whatsappLink}" target="_blank">
                                    <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">Comprar</button>
                                </a>
                            </div>
                        </div>
                    </div>
...
// Llamar esta función al cargar la página y después de agregar un nuevo producto
...
// js/auth.js (o donde manejes la autenticación)
...
// Llamar esta función después del login