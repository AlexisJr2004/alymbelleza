...
// Cascarón reutilizable para TODOS los modales del panel (reemplazo de
// SweetAlert2 en Modal.tsx, y CrudModal.tsx para crear/editar Productos,
// Cupones y Tarjetas). En móvil se comporta como una hoja que sube desde
// abajo sin tapar la parte superior, con esquinas superiores redondeadas y
// una manija que se puede arrastrar hacia abajo para cerrar o soltar antes
// del umbral para que "suba" de nuevo — igual que en iOS. En escritorio es
// un diálogo centrado con fade+scale, sin manija ni gesto de arrastre.
...
interface SheetProps {
  ...
  /** Fondo/bordes/radios del panel. Default: tarjeta blanca. */
  panelClassName?: string;
  /** Color de la manija de arrastre (móvil). Default: gris. */
...
export default function Sheet({
  ...
  // un consumidor que empieza con open=false.
