...
export function ResumenIcon(props: IconProps) {
  return (
    <Icon {...props}>
...
export function CuponesIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.83.699 2.53 0l7.409-7.409a1.79 1.79 0 0 0 0-2.53L13.16 3.66A2.25 2.25 0 0 0 11.568 3H9.568Z"
      />
...
export function TarjetasIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path
        strokeLinecap="round"
...
export function CitasIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path
        strokeLinecap="round"
...
export function UsersInactiveIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path
        strokeLinecap="round"
...
export function ArrowDownIcon(props: IconProps) {
  return (
    <Icon strokeWidth={2} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 17.25 12 21m0 0 3.75-3.75M12 21V3" />
    </Icon>
  );
}
...
// Iconos de estado para el modal propio que reemplaza a SweetAlert2 (ver
// lib/modalStore.ts + components/ui/Modal.tsx).
